  ...
  return (
    <div className="grid grid-cols-5 h-screen">
      ...
      <div className="col-span-4 p-10">
        ...
        <div className="relative flex-grow overflow-auto" ref={scrollToAns}>
          {loader ? (
            // <div className="text-center">
            <div className="absolute inset-0 flex items-center justify-center z-10 bg-zinc-300/60">
              {/* <div className="text-center absolute flex items-center justify-center"> */}
              <div role="status">
                <svg
                  aria-hidden="true"
